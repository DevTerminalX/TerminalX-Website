...
const _siteConfigPath = new URL('./.figma/make/site.json', import.meta.url)
const siteConfiguration = fs.existsSync(_siteConfigPath)
  ? JSON.parse(fs.readFileSync(_siteConfigPath, 'utf-8'))
...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "TerminalX"
